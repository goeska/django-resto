...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-soh4n9#(_qto#s9d6s#dnv4ow6!h&rtwqd3@97d3uvf_y66z+4')
...
DATABASES = {
    'default': dj_database_url.config(
        default=os.environ.get('DATABASE_URL', 'postgresql://goeska:1@localhost:5432/resto_db'),
        conn_max_age=600,
    )
}
